...
for(loop in 1:nrow(iris)) { # open for loop
  
  
      if (iris[i,5] == 'virginica')        # condition
        
                   iris$Audrey_III.Length[loop] <- iris$Pedal.Length[loop]^2.4
      Audrey_III.Length[loop] colname <-
                   # if TRUE
...
title: "Untitled" output: html_document date: "2026-07-10" ---
